<?php
// Migrated from Code Snippet #22 "Calendar Print Button (page 8647)" 2026-06-14 (task 260614-gj8).
// Gate: gasf_site_enable_printbtn (default ON). Backed up in snippets-backup-20260614.sql.
if ( ! defined( 'ABSPATH' ) ) { exit; }
if ( gasf_site_enabled( 'gasf_site_enable_printbtn' ) ) {
/**
